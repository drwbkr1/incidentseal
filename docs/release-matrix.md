...
| Manifest authority | Digest and operator boundary verified; no manifest approved; bounded Python/Node execution contract passes from public custody and blocks packaging | Implementation, approved digest, real verifier, mutation rejection, cancellation and idempotent resume |
