...
| Recovery | Contract candidate; runtime not implemented | Fenced lease and ownership, cancellation, crash, duplicate, idempotent resume, stale, failure, orphan, ambiguous, and conflicting-effect cases |
