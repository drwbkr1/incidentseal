...
- In-progress disposable `topology reliability-probe` with a three-volume protection lock, fresh bootstrap, both real runners, distinct FAIL/INVALID/failed/cancelled observations, post-failure recovery, restart persistence, orphan detection, repeatability, and verified disposable teardown.
